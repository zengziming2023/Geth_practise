...
require (
	...
	github.com/ethersphere/go-sw3 v0.3.0 // indirect
	github.com/ethersphere/swarm v0.5.8 // indirect
	...
	github.com/rnsdomains/rns-go-lib v0.0.0-20191114120302-3505575b0b8f // indirect
